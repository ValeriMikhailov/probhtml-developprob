...
<head>
    ...
    <%--<link rel="stylesheet" type="text/css" href="/static/css/extensions/Editor/css/editor.dataTables.min.css">--%>
    ...
    <%--<script type="text/javascript" src="https://cdn.datatables.net/plug-ins/1.10.19/api/row().show().js"></script>--%>
...
<script type="text/javascript">
    <%@include file="/static/js/jQueryCRUD.js"%>
</script>
</body>
</html>
